...
"border-color: rgb(44, 0, 66);")
        ...
        self.equi_image.setMinimumSize(QtCore.QSize(375, 125))
        ...
        self.scroll_area_ROI.setMinimumSize(QtCore.QSize(0, 0))
    ...
    def retranslateUi(self, Anottation):
        ...
        self.button_go_to_first.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Select one compose ROI in the list and click here to go to the init ROI of the compose ROI.</span></p></body></html>"))
        self.button_go_to_first.setText(_translate("Anottation", "First ROI"))
        self.button_go_to_last.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Select one compose ROI in the list and click here to go to the last ROI of the compose ROI.</span></p></body></html>"))
        ...
        self.button_edit_long_CROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Edit one exist compose ROI. Select one in the list of compose ROI</span></p></body></html>"))
        self.button_edit_long_CROI.setText(_translate("Anottation", "Edit long ROI"))
        self.button_set_init_CROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Set new init ROI in the interval of exist compose ROI to be edit</span></p></body></html>"))
        self.button_set_init_CROI.setText(_translate("Anottation", "Init Frame"))
        self.button_save_CROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Set new final ROI in the interval of exist compose ROI to be edit</span></p></body></html>"))
        ...
        self.label_15.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" font-size:10pt; color:#d500d5;\">Compose ROI consists of a group of ROI which has a first ROI and a final ROI, and between this the program automatic create ROIs.</span></p></body></html>"))
        self.label_15.setText(_translate("Anottation", "Compose ROI"))
        self.button_end_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Select new ROI in image to be the final of compose ROI and click here to save.</span></p></body></html>"))
        self.button_end_ROI.setText(_translate("Anottation", "Save compose ROI"))
        self.button_delete_compose_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Delete one compose ROI. Select one compose ROI in the list.</span></p></body></html>"))
        self.button_delete_compose_ROI.setText(_translate("Anottation", "Delete compose ROI"))
        self.button_edit_one_compose_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Edit one ROI of compose ROI in the current frame showed.</span></p></body></html>"))
        self.button_edit_one_compose_ROI.setText(_translate("Anottation", "Edit one ROI"))
        self.button_add_compose_roi.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Add new final ROI to one exist compose ROI. Select one compose ROI in the list to add the new final ROI.</span></p></body></html>"))
        ...
        self.button_init_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p align=\"center\"><span style=\" font-size:8pt; color:#d500d5;\">Select a ROI in image and click here to set the initial ROI of the group of ROI</span></p></body></html>"))
        ...
        self.button_add_new_CROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Add new group of ROI in one exist compose ROI. Select one compose ROI in the list to add the new group.</span></p></body></html>"))
        self.button_add_new_CROI.setText(_translate("Anottation", "Add new \n"
" compose ROI"))
        self.button_set_new_CROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Select one ROI in the image and click here to set the init ROI of Add new compose ROI</span></p></body></html>"))
        self.button_set_new_CROI.setText(_translate("Anottation", "Set Init \n"
" Add ROI"))
        self.label_16.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" font-size:10pt; color:#d500d5;\">Single ROI consists of a single ROI in a single frame.</span></p></body></html>"))
        self.label_16.setText(_translate("Anottation", "Single ROI"))
        self.button_edit_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Edit one single ROI. Select one ROI in the image and click here.</span></p></body></html>"))
        ...
        self.button_save_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Save one single ROI. Select one ROI in the image and click here.</span></p></body></html>"))
        self.button_save_ROI.setText(_translate("Anottation", "Save Single ROI"))
        self.button_delete_ROI.setToolTip(_translate("Anottation", "<html><head/><body><p><span style=\" color:#d500d5;\">Delete one single ROI. Select one single ROI in the list to delete.</span></p></body></html>"))
        self.button_delete_ROI.setText(_translate("Anottation", "Delete Single ROI"))
