...
class Ui_Anottation_small(object):
    def setupUi(self, Anottation_small):
        Anottation_small.setObjectName("Anottation_small")
        Anottation_small.resize(1119, 825)
        Anottation_small.setLayoutDirection(QtCore.Qt.LeftToRight)
        Anottation_small.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(42, 44, 111, 255), stop:0.315789 rgba(28, 29, 73, 255));\n"
"color:rgb(255,255,255);\n"
"border-color: rgb(44, 0, 66);")
        self.window = QtWidgets.QWidget(Anottation_small)
        ...
        self.scroll_area_ROI_contents.setGeometry(QtCore.QRect(0, 0, 227, 198))
        ...
        self.scroll_area_ROI_contents_2.setGeometry(QtCore.QRect(0, 0, 226, 198))
        ...
        Anottation_small.setCentralWidget(self.window)
        self.menubar = QtWidgets.QMenuBar(Anottation_small)
        ...
        Anottation_small.setMenuBar(self.menubar)
        self.button_upload_image = QtWidgets.QAction(Anottation_small)
        self.button_upload_image.setObjectName("button_upload_image")
        self.button_upload_folder = QtWidgets.QAction(Anottation_small)
        self.button_upload_folder.setObjectName("button_upload_folder")
        self.button_upload_video = QtWidgets.QAction(Anottation_small)
        self.button_upload_video.setObjectName("button_upload_video")
        self.button_save = QtWidgets.QAction(Anottation_small)
        self.button_save.setObjectName("button_save")
        self.button_upload_Annotations = QtWidgets.QAction(Anottation_small)
        ...
        self.retranslateUi(Anottation_small)
        QtCore.QMetaObject.connectSlotsByName(Anottation_small)

    def retranslateUi(self, Anottation_small):
        _translate = QtCore.QCoreApplication.translate
        Anottation_small.setWindowTitle(_translate("Anottation_small", "MainWindow"))
        self.button_go_to_first.setText(_translate("Anottation_small", "First ROI"))
        self.button_go_to_last.setText(_translate("Anottation_small", "Last ROI"))
        self.label.setText(_translate("Anottation_small", "Equirectangular View"))
        self.button_play_video.setText(_translate("Anottation_small", "Play"))
        self.button_pause_video.setText(_translate("Anottation_small", "Pause"))
        self.button_set_init_CROI.setText(_translate("Anottation_small", "Init Frame"))
        self.button_edit_long_CROI.setText(_translate("Anottation_small", "Edit long ROI"))
        self.button_save_CROI.setText(_translate("Anottation_small", "Save edit"))
        self.label_2.setText(_translate("Anottation_small", "Perspective View"))
        self.label_4.setText(_translate("Anottation_small", "ROI H"))
        self.label_3.setText(_translate("Anottation_small", "ROI W"))
        self.label_6.setText(_translate("Anottation_small", "POS X"))
        self.label_5.setText(_translate("Anottation_small", "POS Y"))
        self.label_15.setText(_translate("Anottation_small", "Compose ROI"))
        self.button_end_ROI.setText(_translate("Anottation_small", "Save compose ROI"))
        self.button_delete_compose_ROI.setText(_translate("Anottation_small", "Delete compose ROI"))
        self.button_edit_one_compose_ROI.setText(_translate("Anottation_small", "Edit one ROI"))
        self.button_add_compose_roi.setText(_translate("Anottation_small", "Add ROIs"))
        self.button_cancel_edit_compose_ROI.setText(_translate("Anottation_small", "Cancel"))
        self.button_init_ROI.setText(_translate("Anottation_small", "Set Init ROI"))
        self.button_save_add_ROI.setText(_translate("Anottation_small", "Save add ROIs"))
        self.button_save_edit_compose_ROI.setText(_translate("Anottation_small", "Save Edit"))
        self.button_add_new_CROI.setText(_translate("Anottation_small", "Add new \n"
" compose ROI"))
        self.button_set_new_CROI.setText(_translate("Anottation_small", "Set Init \n"
" Add ROI"))
        self.label_16.setText(_translate("Anottation_small", "Single ROI"))
        self.button_edit_ROI.setText(_translate("Anottation_small", "Edit"))
        self.button_save_edit.setText(_translate("Anottation_small", "Save Edit"))
        self.button_cancel_edit.setText(_translate("Anottation_small", "Cancel Edit"))
        self.button_save_ROI.setText(_translate("Anottation_small", "Save"))
        self.button_delete_ROI.setText(_translate("Anottation_small", "Delete"))
        self.menuUpload.setTitle(_translate("Anottation_small", "File"))
        self.button_upload_image.setText(_translate("Anottation_small", "Upload Image"))
        self.button_upload_folder.setText(_translate("Anottation_small", "Upload Folder"))
        self.button_upload_video.setText(_translate("Anottation_small", "Upload Video"))
        self.button_save.setText(_translate("Anottation_small", "Save"))
        self.button_upload_Annotations.setText(_translate("Anottation_small", "Upload Annotations"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Anottation_small = QtWidgets.QMainWindow()
    ui = Ui_Anottation_small()
    ui.setupUi(Anottation_small)
    Anottation_small.show()
    sys.exit(app.exec_())
